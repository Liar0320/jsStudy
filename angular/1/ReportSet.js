...
(function () {
    ...
    decCreateLink.$inject = ['ngDialog', '$ocLazyLoad'];
    function decCreateLink(ngDialog,$ocLazyLoad) {
        return {
            restrict: 'A',
            link: function (scope,ele,attr) {
                ...
                document.getElementsByClassName('control-collect')[0].addEventListener('mousedown', function (e) {
                    ...
                    dragDownItem.transferData = { data: e.target.innerText, type: node.getAttribute('type') }
                }) ///侧栏数据的box被按下时存储交换信息
                ...
                function createControl() {
                    ...
                    let controlComponentButton = document.createElement('button');
                    controlComponentButton.innerText = '放大'
                    controlComponentButton.addEventListener('click', function (e) {
                    ...
                    controlComponent.appendChild(controlComponentButton);
